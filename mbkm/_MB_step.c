...
#define __PYX_HAVE__mbkm___MB_step
#define __PYX_HAVE_API__mbkm___MB_step
#include "math.h"
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
 ...
 * 
 */
typedef __pyx_t_5numpy_float64_t __pyx_t_4mbkm_8_MB_step_DOUBLE;

/* "mbkm/_MB_step.pyx":23
 * 
 * ctypedef np.float64_t DOUBLE
 * ctypedef np.int32_t INT             # <<<<<<<<<<<<<<
 * 
 ...
 */
typedef __pyx_t_5numpy_int32_t __pyx_t_4mbkm_8_MB_step_INT;
/* None.proto */
#if CYTHON_CCOMPLEX
  #ifdef __cplusplus
...
/* Module declarations from 'mbkm._MB_step' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE = { "DOUBLE", NULL, sizeof(__pyx_t_4mbkm_8_MB_step_DOUBLE), { 0 }, 0, 'R', 0, 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_INT = { "INT", NULL, sizeof(__pyx_t_4mbkm_8_MB_step_INT), { 0 }, 0, IS_UNSIGNED(__pyx_t_4mbkm_8_MB_step_INT) ? 'U' : 'I', IS_UNSIGNED(__pyx_t_4mbkm_8_MB_step_INT), 0 };
static __Pyx_TypeInfo __Pyx_TypeInfo_int = { "int", NULL, sizeof(int), { 0 }, 0, IS_UNSIGNED(int) ? 'U' : 'I', IS_UNSIGNED(int), 0 };
#define __Pyx_MODULE_NAME "mbkm._MB_step"
int __pyx_module_is_main_mbkm___MB_step = 0;

/* Implementation of 'mbkm._MB_step' */
...
static const char __pyx_k_mbkm__MB_step[] = "mbkm._MB_step";
...
static const char __pyx_k_mini_batch_update_csr[] = "_mini_batch_update_csr";
static const char __pyx_k_sklearn_utils_extmath[] = "sklearn.utils.extmath";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_Users_tangch_Documents_Python_p[] = "/Users/tangch/Documents/Python_projects/myprojects/mbkm_2016/mbkm/_MB_step.pyx";
...
static PyObject *__pyx_n_s_mbkm__MB_step;
...
static PyObject *__pyx_pf_4mbkm_8_MB_step__mini_batch_update_csr(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_X, CYTHON_UNUSED PyArrayObject *__pyx_v_x_squared_norms, PyArrayObject *__pyx_v_centers, PyArrayObject *__pyx_v_counts, PyArrayObject *__pyx_v_nearest_center, PyArrayObject *__pyx_v_old_center, int __pyx_v_compute_squared_diff, int __pyx_v_curr_iter, __pyx_t_4mbkm_8_MB_step_DOUBLE __pyx_v_learn_rate); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4mbkm_8_MB_step_1_mini_batch_update_csr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_4mbkm_8_MB_step__mini_batch_update_csr[] = "Incremental update of the centers for sparse MiniBatchKMeans.\n    Parameters\n    ----------\n    X: CSR matrix, dtype float64\n        The complete (pre allocated) training set as a CSR matrix.\n    centers: array, shape (n_clusters, n_features)\n        The cluster centers\n    counts: array, shape (n_clusters,)\n         The vector in which we keep track of the numbers of elements in a\n         cluster\n    Returns\n    -------\n    inertia: float\n        The inertia of the batch prior to centers update, i.e. the sum\n        distances to the closest center for each sample. This is the objective\n        function being minimized by the k-means algorithm.\n    squared_diff: float\n        The sum of squared update (squared norm of the centers position\n        change). If compute_squared_diff is 0, this computation is skipped and\n        0.0 is returned instead.\n    Both squared diff and inertia are commonly used to monitor the convergence\n    of the algorithm.\n    ";
static PyMethodDef __pyx_mdef_4mbkm_8_MB_step_1_mini_batch_update_csr = {"_mini_batch_update_csr", (PyCFunction)__pyx_pw_4mbkm_8_MB_step_1_mini_batch_update_csr, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4mbkm_8_MB_step__mini_batch_update_csr};
static PyObject *__pyx_pw_4mbkm_8_MB_step_1_mini_batch_update_csr(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_t_4mbkm_8_MB_step_DOUBLE __pyx_v_learn_rate;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("_mini_batch_update_csr (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_X,&__pyx_n_s_x_squared_norms,&__pyx_n_s_centers,&__pyx_n_s_counts,&__pyx_n_s_nearest_center,&__pyx_n_s_old_center,&__pyx_n_s_compute_squared_diff,&__pyx_n_s_curr_iter,&__pyx_n_s_learn_rate,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_x_squared_norms)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 1); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_centers)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 2); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_counts)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 3); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_nearest_center)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 4); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  5:
        if (likely((values[5] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_old_center)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 5); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  6:
        if (likely((values[6] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_compute_squared_diff)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 6); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  7:
        if (likely((values[7] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_curr_iter)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 7); __PYX_ERR(0, 34, __pyx_L3_error)
        }
        case  8:
        if (likely((values[8] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_learn_rate)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, 8); __PYX_ERR(0, 34, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "_mini_batch_update_csr") < 0)) __PYX_ERR(0, 34, __pyx_L3_error)
      }
    ...
    __pyx_v_compute_squared_diff = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_compute_squared_diff == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
    __pyx_v_curr_iter = __Pyx_PyInt_As_int(values[7]); if (unlikely((__pyx_v_curr_iter == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 40, __pyx_L3_error)
    __pyx_v_learn_rate = __pyx_PyFloat_AsDouble(values[8]); if (unlikely((__pyx_v_learn_rate == (npy_float64)-1) && PyErr_Occurred())) __PYX_ERR(0, 42, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("_mini_batch_update_csr", 1, 9, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 34, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("mbkm._MB_step._mini_batch_update_csr", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_counts), __pyx_ptype_5numpy_ndarray, 1, "counts", 0))) __PYX_ERR(0, 36, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_nearest_center), __pyx_ptype_5numpy_ndarray, 1, "nearest_center", 0))) __PYX_ERR(0, 37, __pyx_L1_error)
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_old_center), __pyx_ptype_5numpy_ndarray, 1, "old_center", 0))) __PYX_ERR(0, 38, __pyx_L1_error)
  __pyx_r = __pyx_pf_4mbkm_8_MB_step__mini_batch_update_csr(__pyx_self, __pyx_v_X, __pyx_v_x_squared_norms, __pyx_v_centers, __pyx_v_counts, __pyx_v_nearest_center, __pyx_v_old_center, __pyx_v_compute_squared_diff, __pyx_v_curr_iter, __pyx_v_learn_rate);
...
static PyObject *__pyx_pf_4mbkm_8_MB_step__mini_batch_update_csr(CYTHON_UNUSED PyObject *__pyx_self, PyObject *__pyx_v_X, CYTHON_UNUSED PyArrayObject *__pyx_v_x_squared_norms, PyArrayObject *__pyx_v_centers, PyArrayObject *__pyx_v_counts, PyArrayObject *__pyx_v_nearest_center, PyArrayObject *__pyx_v_old_center, int __pyx_v_compute_squared_diff, int __pyx_v_curr_iter, __pyx_t_4mbkm_8_MB_step_DOUBLE __pyx_v_learn_rate) {
  ...
  __pyx_t_4mbkm_8_MB_step_DOUBLE __pyx_v_eta;
  ...
  __pyx_t_4mbkm_8_MB_step_DOUBLE __pyx_v_squared_diff;
  ...
  __Pyx_TraceCall("_mini_batch_update_csr", __pyx_f[0], 34, 0, __PYX_ERR(0, 34, __pyx_L1_error));
  ...
  __pyx_pybuffernd_old_center.rcbuffer = &__pyx_pybuffer_old_center;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_x_squared_norms.rcbuffer->pybuffer, (PyObject*)__pyx_v_x_squared_norms, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_centers.rcbuffer->pybuffer, (PyObject*)__pyx_v_centers, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_counts.rcbuffer->pybuffer, (PyObject*)__pyx_v_counts, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_INT, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_nearest_center.rcbuffer->pybuffer, (PyObject*)__pyx_v_nearest_center, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_INT, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_old_center.rcbuffer->pybuffer, (PyObject*)__pyx_v_old_center, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) __PYX_ERR(0, 34, __pyx_L1_error)
  }
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_X, __pyx_n_s_data); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 68, __pyx_L1_error)
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_X_data.rcbuffer->pybuffer, (PyObject*)__pyx_t_2, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_X, __pyx_n_s_indices); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_v_X, __pyx_n_s_indptr); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 70, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_t_5 = __Pyx_GetItemInt(__pyx_t_1, 0, long, 1, __Pyx_PyInt_From_long, 0, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
  __pyx_t_6 = __Pyx_PyInt_As_unsigned_int(__pyx_t_5); if (unlikely((__pyx_t_6 == (unsigned int)-1) && PyErr_Occurred())) __PYX_ERR(0, 71, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_n_samples = __pyx_t_6;

  /* "mbkm/_MB_step.pyx":72
 *         np.ndarray[int, ndim=1] X_indptr = X.indptr
 *         unsigned int n_samples = X.shape[0]
 *         unsigned int n_clusters = centers.shape[0]             # <<<<<<<<<<<<<<
 *         unsigned int n_features = centers.shape[1]
 ...
 */
    ...
    __pyx_v_old_count = (*__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_INT *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_8, __pyx_pybuffernd_counts.diminfo[0].strides));

    /* "mbkm/_MB_step.pyx":87
 *     for center_idx in range(n_clusters):
 *         old_count = counts[center_idx]
 *         new_count = old_count             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_12 = (((*__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_INT *, __pyx_pybuffernd_nearest_center.rcbuffer->pybuffer.buf, __pyx_t_11, __pyx_pybuffernd_nearest_center.diminfo[0].strides)) == __pyx_v_center_idx) != 0);
      if (__pyx_t_12) {

        /* "mbkm/_MB_step.pyx":92
 *         for sample_idx in range(n_samples):
 *             if nearest_center[sample_idx] == center_idx:
 *                 new_count += 1             # <<<<<<<<<<<<<<
 * 
 ...
 *         ### Added
 */
      __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_centers), __pyx_v_center_idx, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 101, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      if (__Pyx_PyObject_SetSlice(((PyObject *)__pyx_v_old_center), __pyx_t_5, 0, 0, NULL, NULL, &__pyx_slice__2, 0, 0, 0) < 0) __PYX_ERR(0, 101, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_1, __pyx_n_s_zeros); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = __Pyx_PyInt_From_unsigned_int(__pyx_v_n_features); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 104, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __pyx_t_14 = NULL;
    ...
    if (!__pyx_t_14) {
      __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_13, __pyx_t_1); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_GOTREF(__pyx_t_5);
    } else {
      ...
      __pyx_t_1 = 0;
      __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_13, __pyx_t_15, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 104, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
    ...
    __pyx_t_16 = ((PyArrayObject *)__pyx_t_5);
    {
      ...
      __pyx_t_17 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_new_center.rcbuffer->pybuffer, (PyObject*)__pyx_t_16, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_17 < 0)) {
        PyErr_Fetch(&__pyx_t_18, &__pyx_t_19, &__pyx_t_20);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_new_center.rcbuffer->pybuffer, (PyObject*)__pyx_v_new_center, &__Pyx_TypeInfo_nn___pyx_t_4mbkm_8_MB_step_DOUBLE, PyBUF_FORMAT| PyBUF_STRIDES| PyBUF_WRITABLE, 1, 0, __pyx_stack) == -1)) {
      ...
      if (unlikely(__pyx_t_17 < 0)) __PYX_ERR(0, 104, __pyx_L1_error)
    }
    __pyx_t_16 = 0;
    __Pyx_XDECREF_SET(__pyx_v_new_center, ((PyArrayObject *)__pyx_t_5));
    __pyx_t_5 = 0;

    /* "mbkm/_MB_step.pyx":109
 ...
 */
      ...
      __pyx_t_12 = (((*__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_INT *, __pyx_pybuffernd_nearest_center.rcbuffer->pybuffer.buf, __pyx_t_21, __pyx_pybuffernd_nearest_center.diminfo[0].strides)) != __pyx_v_center_idx) != 0);
      if (__pyx_t_12) {

        /* "mbkm/_MB_step.pyx":111
 *         for sample_idx in range(n_samples):
 *             if nearest_center[sample_idx] != center_idx:
 *                 continue             # <<<<<<<<<<<<<<
 * 
 ...
 */
      ...
      __pyx_t_17 = (*__Pyx_BufPtrStrided1d(int *, __pyx_pybuffernd_X_indptr.rcbuffer->pybuffer.buf, __pyx_t_22, __pyx_pybuffernd_X_indptr.diminfo[0].strides));
      __pyx_t_23 = __pyx_v_sample_idx;
      for (__pyx_t_24 = (*__Pyx_BufPtrStrided1d(int *, __pyx_pybuffernd_X_indptr.rcbuffer->pybuffer.buf, __pyx_t_23, __pyx_pybuffernd_X_indptr.diminfo[0].strides)); __pyx_t_24 < __pyx_t_17; __pyx_t_24+=1) {
        __pyx_v_k = __pyx_t_24;

        /* "mbkm/_MB_step.pyx":119
 *             ###
 *             #   centers[center_idx, X_indices[k]] += X_data[k]
 ...
 */
        ...
        __pyx_t_27 = (*__Pyx_BufPtrStrided1d(int *, __pyx_pybuffernd_X_indices.rcbuffer->pybuffer.buf, __pyx_t_26, __pyx_pybuffernd_X_indices.diminfo[0].strides));
        *__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_DOUBLE *, __pyx_pybuffernd_new_center.rcbuffer->pybuffer.buf, __pyx_t_27, __pyx_pybuffernd_new_center.diminfo[0].strides) += (*__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_DOUBLE *, __pyx_pybuffernd_X_data.rcbuffer->pybuffer.buf, __pyx_t_25, __pyx_pybuffernd_X_data.diminfo[0].strides));
      }
      __pyx_L10_continue:;
    }

    /* "mbkm/_MB_step.pyx":122
 *             ###
 *         # inplace rescale center with updated count
 *         if new_count > old_count:             # <<<<<<<<<<<<<<
 ...
 */
      ...
      *__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_INT *, __pyx_pybuffernd_counts.rcbuffer->pybuffer.buf, __pyx_t_28, __pyx_pybuffernd_counts.diminfo[0].strides) = __pyx_v_new_count;

      /* "mbkm/_MB_step.pyx":129
 ...
 */
      __pyx_t_5 = __Pyx_GetItemInt(((PyObject *)__pyx_v_centers), __pyx_v_center_idx, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_5);
      __pyx_t_13 = PyFloat_FromDouble(__pyx_v_eta); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_13);
      __pyx_t_15 = __Pyx_PyInt_From_unsigned_int((__pyx_v_new_count - __pyx_v_old_count)); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __pyx_t_1 = __Pyx_PyNumber_Divide(((PyObject *)__pyx_v_new_center), __pyx_t_15); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_1);
      __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      __pyx_t_15 = __Pyx_GetItemInt(((PyObject *)__pyx_v_centers), __pyx_v_center_idx, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __pyx_t_14 = PyNumber_Subtract(__pyx_t_1, __pyx_t_15); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
      __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      __pyx_t_15 = PyNumber_Multiply(__pyx_t_13, __pyx_t_14); if (unlikely(!__pyx_t_15)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_15);
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;
      __pyx_t_14 = PyNumber_Add(__pyx_t_5, __pyx_t_15); if (unlikely(!__pyx_t_14)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_14);
      __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
      __Pyx_DECREF(__pyx_t_15); __pyx_t_15 = 0;
      if (unlikely(__Pyx_SetItemInt(((PyObject *)__pyx_v_centers), __pyx_v_center_idx, __pyx_t_14, unsigned int, 0, __Pyx_PyInt_From_unsigned_int, 0, 0, 0) < 0)) __PYX_ERR(0, 134, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_14); __pyx_t_14 = 0;

      /* "mbkm/_MB_step.pyx":138
 *             # update the incremental computation of the squared total
 ...
 * 
 */
          __pyx_v_squared_diff = (__pyx_v_squared_diff + pow(((*__Pyx_BufPtrStrided1d(__pyx_t_4mbkm_8_MB_step_DOUBLE *, __pyx_pybuffernd_old_center.rcbuffer->pybuffer.buf, __pyx_t_29, __pyx_pybuffernd_old_center.diminfo[0].strides)) - (*__Pyx_BufPtrStrided2d(__pyx_t_4mbkm_8_MB_step_DOUBLE *, __pyx_pybuffernd_centers.rcbuffer->pybuffer.buf, __pyx_t_30, __pyx_pybuffernd_centers.diminfo[0].strides, __pyx_t_31, __pyx_pybuffernd_centers.diminfo[1].strides))), 2.0));
        }
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_n_s_mbkm__MB_step, __pyx_k_mbkm__MB_step, sizeof(__pyx_k_mbkm__MB_step), 0, 0, 1, 1},
 ...
 *                            np.ndarray[INT, ndim=1] counts,
 */
  __pyx_tuple__10 = PyTuple_Pack(26, __pyx_n_s_X, __pyx_n_s_x_squared_norms, __pyx_n_s_centers, __pyx_n_s_counts, __pyx_n_s_nearest_center, __pyx_n_s_old_center, __pyx_n_s_compute_squared_diff, __pyx_n_s_curr_iter, __pyx_n_s_learn_rate, __pyx_n_s_X_data, __pyx_n_s_X_indices, __pyx_n_s_X_indptr, __pyx_n_s_n_samples, __pyx_n_s_n_clusters, __pyx_n_s_n_features, __pyx_n_s_eta, __pyx_n_s_iter, __pyx_n_s_sample_idx, __pyx_n_s_center_idx, __pyx_n_s_feature_idx, __pyx_n_s_k, __pyx_n_s_old_count, __pyx_n_s_new_count, __pyx_n_s_center_diff, __pyx_n_s_squared_diff, __pyx_n_s_new_center); if (unlikely(!__pyx_tuple__10)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__10);
  __Pyx_GIVEREF(__pyx_tuple__10);
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(9, 0, 26, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__10, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_Users_tangch_Documents_Python_p, __pyx_n_s_mini_batch_update_csr, 34, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_MB_step(void); /*proto*/
PyMODINIT_FUNC init_MB_step(void)
#else
PyMODINIT_FUNC PyInit__MB_step(void); /*proto*/
PyMODINIT_FUNC PyInit__MB_step(void)
#endif
{
  __Pyx_TraceDeclarations
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__MB_step(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_MB_step", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_mbkm___MB_step) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mbkm._MB_step")) {
      if (unlikely(PyDict_SetItemString(modules, "mbkm._MB_step", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  #endif
  __Pyx_TraceCall("PyMODINIT_FUNC PyInit__MB_step(void)", __pyx_f[0], 1, 0, __PYX_ERR(0, 1, __pyx_L1_error));

  /* "mbkm/_MB_step.pyx":12
 * 
 ...
 *                            np.ndarray[INT, ndim=1] counts,
 */
  __pyx_t_2 = PyCFunction_NewEx(&__pyx_mdef_4mbkm_8_MB_step_1_mini_batch_update_csr, NULL, __pyx_n_s_mbkm__MB_step); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_mini_batch_update_csr, __pyx_t_2) < 0) __PYX_ERR(0, 34, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mbkm._MB_step", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mbkm._MB_step");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
